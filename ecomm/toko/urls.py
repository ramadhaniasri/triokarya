...
urlpatterns = [
     ...
     path('update-payment-status/<int:order_id>/<str:payment_status>/', views.update_payment_status, name='update_payment_status'),
     path('update-payment-status/<int:order_id>/<str:payment_status>/<str:shipping_status>/', views.update_payment_status, name='update_payment_status_with_shipping'),
